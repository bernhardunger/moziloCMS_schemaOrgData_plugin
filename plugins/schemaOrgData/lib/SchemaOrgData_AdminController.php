...
*
* Anzeige-Bausteine des Admin-Formulars (Refactoring-Schritt 12a,
* siehe doc/adr_komponenten_refactoring.md, "Ebene A"): Info-Block,
...
* Ausschlussliste, Admin-CSS sowie die feldweise Vererbungsanzeige
* (resolveInheritableFields()). Orchestrierung/Persistenz
* (renderScopeSection(), sanitizePostData(), saveConfig() usw.,
* "Ebene B") folgen mit Refactoring-Schritt 12b.
*
* Zustandslos: Kollaboratoren (Language, SchemaOrgData_ScopeResolver,
* $this->settings) werden je Aufruf als Parameter übergeben, nicht im
