...
[compatibility.md](compatibility.md#abhaengigkeiten)) ist reiner Komfort — sie kann durch deaktiviertes JavaScript oder
...
[compatibility.md](compatibility.md#abhaengigkeiten).

## Siehe auch

- [../README.md](../README.md#sicherheit) — Kurzübersicht
- [compatibility.md](compatibility.md#abhaengigkeiten) — AJV.js im Detail, warum lokal statt CDN
