...
final class JsonLdBuilderTest extends TestCase {
    ...
    function testRequiredFieldsProduceValidJsonLd(): void {
        ...
        $this->assertSame('Steuerkanzlei Hader', $decoded['name']);
        $this->assertSame('https://steuerkanzlei-hader.de', $decoded['url']);
    }
    ...
    function testPostalAddressIsNestedCorrectly(): void {
        ...
        $this->assertSame('München', $decoded['address']['addressLocality']);
